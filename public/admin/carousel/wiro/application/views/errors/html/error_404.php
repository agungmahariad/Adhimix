<?php //if(!function_exists('base_url')){ include BASEPATH.'helpers/url_helper.php'; } ?>
<!DOCTYPE html>
<html lang="en-us">
  <head>
    <meta charset="utf-8">
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="text-center error-box">
                  ...
                  <br />
                  <p class="lead">The page you requested could not be found, either contact your webmaster or try again.</br>
                  Use your browsers Back button to navigate to the page you have prevously come from.</p>
                  <p class="font-md">
                    <b>... or you prefer</b>
                  
                  <button type="button" class="btn btn-primary" onclick='location.href="<?//=base_url('App/dashboard')?>"'>
